...

{
  ...
  users.users.globule = {
    ...
    hashedPassword = "$6$Lf6TET.vPzKo0Hpa$ahEqQ73z.4OhjWebDm/tFFyeZJYNnZs8LMIPdX3DkkKTONioT/PMihbickhOiK8wHa78S6iiDybPzdJdk./u7.";
  };
  ...
  users.users.globule.openssh.authorizedKeys.keys = [
    # change this to your ssh key
    "ssh-rsa  globule@DESKTOP-GKNKPA5"
  ];
